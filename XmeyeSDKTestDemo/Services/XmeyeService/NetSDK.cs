...
using System.Text;
using SDK_HANDLE = int;
#pragma warning disable CA1051,CA1810,CA1815,CA2201,CA2211,CA2020,CS8600,CS8603,CS8605,CS8625,CA1838

namespace User.NetSDK;
...
public enum SDK_RET_CODE
{
    ...
    H264_DVR_NAT_REALPLAY_MAX = -12002, //序列号同时预览数达到最大，请关闭其它预览窗口再打开
};
...
{
    public const Int32 TCPSOCKET = 0; //普通IP登录
    public const Int32 UDPSOCKET = 1;
    public const Int32 NATOBJECT = 2; //序列号登录
};
...
public struct SDK_CONFIG_NET_COMMON_V2
{
    ...
    [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 32)]
    public string pLocalLinkAddr; //本地链路地址

    [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 64)]
    public string pAddr; //ipv6地址
...
public struct SDK_SYSTEM_TIME
{
    ...
    ///< 月，January = 1, February = 2, and so on.
    public Int32 day;

    ///< 日。
    public Int32 wday;

    ///< 星期，Sunday = 0, Monday = 1, and so on
    public Int32 hour;
...
public struct H264_DVR_CLIENTINFO
{
    ...
    public override readonly string ToString() =>
        $"{nameof(nChannel)}={nChannel}, {nameof(nStream)}={nStream}, {nameof(nMode)}={nMode}, {nameof(nComType)}={nComType}, {nameof(hWnd)}={hWnd}";
}
...
public struct H264_DVR_FINDINFO
{
    ...
    public uint hWnd;
    public Int32 StreamType; //查询的码流类型,主码流:0,辅码流:1

    [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 32)]
    public string sEvent; //自定义文件类型:SDK_File_Type为SDK_FILE_CUSTOM时需要传入，否则为空

    [MarshalAs(UnmanagedType.ByValTStr, SizeConst = 32)]
    public string sFileFormat; //自定义文件格式:SDK_File_Type为SDK_FILE_CUSTOM时需要传入，否则为空
};
...
public struct SDK_VIDEOCOLOR_PARAM
{
    ...
    ///< 增益	0-100 第７位置1表示自动增益
    public Int32 mWhitebalance;

    ///< 自动白电平控制，bit7置位表示开启自动控制.0x0,0x1,0x2分别代表低,中,高等级
...
{
    public MEDIA_PACK_TYPE nPacketType; // 包类型,见 MEDIA_PACK_TYPE
    public IntPtr pPacketBuffer; // 缓存区地址
    public uint dwPacketSize; // 包的大小
    public SDK_ENCODE_TYPE nEncodeType; // 流类型 见 SDK_ENCODE_TYPE

    ///数据格式类型见 SDK_ENCODE_TYPE
    // 绝对时标
...
public enum SDK_EncodeFunctionTypes
{
    ...
    ///< 双码流功能
    SDK_ENCODE_FUNCTION_TYPE_COMBINE_STREAM,

    ///< 组合编码功能
    SDK_ENCODE_FUNCTION_TYPE_SNAP_STREAM,

    ///< 抓图功能
    SDK_ENCODE_FUNCTION_TYPE_WATER_MARK,
...
public enum SDK_NetServerTypes
{
    ...
    ///< 白黑名单
    SDK_NET_SERVER_TYPES_DHCP,

    ///< DHCP功能
    SDK_NET_SERVER_TYPES_DDNS,

    ///< DDNS功能
    SDK_NET_SERVER_TYPES_EMAIL,

    ///< Email功能
    SDK_NET_SERVER_TYPES_MULTICAST,

    ///< 多播功能
    SDK_NET_SERVER_TYPES_NTP,

    ///< NTP功能
    SDK_NET_SERVER_TYPES_PPPOE,
    SDK_NET_SERVER_TYPES_DNS,
    SDK_NET_SERVER_TYPES_ARSP,

    ///< 主动注册服务
    SDK_NET_SERVER_TYPES_3G,

    ///< 3G拨号
    SDK_NET_SERVER_TYPES_MOBILE = 10,

    ///< 手机监控
    SDK_NET_SERVER_TYPES_UPNP,

    ///< UPNP
    SDK_NET_SERVER_TYPES_FTP,

    ///< FTP
    SDK_NET_SERVER_TYPES_WIFI,

    ///<WIFI
    SDK_NET_SERVER_TYPES_ALARM_CENTER,

    ///< 告警中心
    SDK_NET_SERVER_TYPES_NETPLAT_MEGA,
    ...
    SDK_NET_SERVER_TYPES_GOD_EYE,

    ///<神眼接警中心系统
    SDK_NET_SERVER_TYPES_NAT,

    ///NAT穿透，MTU配置
    SDK_NET_SERVER_TYPES_VPN,

    ///VPN
    SDK_NET_SERVER_TYPES_NET_KEYBOARD,

    ///网络键盘配置
    SDK_NET_SERVER_TYPES_SPVMN,
    ...
    ///凯聪配置
    SDK_NET_SERVER_TYPE_PROTOCOL_MAC,
...
{
    SDK_COMM_TYPES_RS485,

    ///<485串口
    SDK_COMM_TYPES_RS232,
...
{
    SDK_PREVIEW_TYPES_TOUR,

    ///< 轮巡
    SDK_PREVIEW_TYPES_TALK,
...
[StructLayout(LayoutKind.Sequential)]
public struct SDK_DriverInformation
{
    public Int32 iDriverType;
    public bool bIsCurrent;
    public Int32 uiTotalSpace;

    ///< 总容量，MB为单位
    public Int32 uiRemainSpace;

    ///< 剩余容量，MB为单位
    public Int32 iStatus;

    ///< 错误标志，文件系统初始化时被设置
    public Int32 iLogicSerialNo;

    ///< 逻辑序号
    public SDK_SYSTEM_TIME tmStartTimeNew;

    ///< 新录像时间段的开始时间
    public SDK_SYSTEM_TIME tmEndTimeNew;

    ///< 新录像时间段的结束时间
    public SDK_SYSTEM_TIME tmStartTimeOld;

    ///< 老录像时间段的开始时间
    public SDK_SYSTEM_TIME tmEndTimeOld;
...
public struct SDK_STORAGEDISK
{
    public Int32 iPhysicalNo;
    public Int32 iPartNumber;
    ...
    ///<序列号
    [MarshalAs(UnmanagedType.ByValArray, SizeConst = 4)]
    public SDK_DriverInformation[] diPartitions;
};

public struct SDK_StorageDeviceInformationAll
{
    public Int32 iDiskNumber;

    [MarshalAs(UnmanagedType.ByValArray, SizeConst = 8)]
    public SDK_STORAGEDISK[] vStorageDeviceInfoAll;
}
...
public class NetSDK
{
    ...
    public delegate void fTransComCallBack(
        SDK_HANDLE lLoginID,
        int lTransComType,
    ...
    public delegate int fRealDataCallBack(
        SDK_HANDLE lRealHandle,
        int dwDataType,
        string strBuf,
        int lbufsize,
        int dwUser
    ...
    private const string DllPath = "./Services/XmeyeService/NetSdk.dll";
    ...
    [DllImport(DllPath)]
    public static extern SDK_HANDLE H264_DVR_Login(
        string sDVRIP,
        ushort wDVRPort,
        string sUserName,
        string sPassword,
        ref H264_DVR_DEVICEINFO lpDeviceInfo,
        out int error,
        Int32 socketstyle
    );
    ...
    [DllImport(DllPath)]
    public static extern int H264_DVR_GetDevConfig(
        SDK_HANDLE lLoginID,
        uint dwCommand,
        int nChannelNO,
        IntPtr bufptr,
    ...
    [DllImport(DllPath)]
    public static extern int H264_DVR_SetDevConfig(
        SDK_HANDLE lLoginID,
        uint dwCommand,
        int nChannelNO,
        IntPtr bufptr,
    ...
    [DllImport(DllPath)]
    public static extern bool H264_DVR_LocalSetColor(
        SDK_HANDLE lHandle,
        UInt32 nRegionNum,
        int nBrightness,
        int nContrast,
    ...
    [DllImport(DllPath)]
    public static extern bool H264_DVR_LocalGetColor(
        SDK_HANDLE lHandle,
        UInt32 nRegionNum,
        out int pBrightness,
        out int pContrast,
    ...
    [DllImport(DllPath)]
    public static extern SDK_HANDLE H264_DVR_Login(
        StringBuilder sDVRIP,
        ushort wDVRPort,
        StringBuilder sUserName,
        StringBuilder sPassword,
        out H264_DVR_DEVICEINFO lpDeviceInfo,
        out short error,
        Int32 socketstyle
    );
    ...
    [DllImport(DllPath)]
    public static extern void DisConnectBackCallFunc(
        SDK_HANDLE lLoginID,
        IntPtr pchDVRIP,
        ushort nDVRPort,
        uint dwUser
    ...
    [DllImport(DllPath)]
    public static extern bool H264_DVR_OpenTransComChannel(
        SDK_HANDLE lLoginID,
        ref TransComChannel TransInfo,
    ...
    [DllImport(DllPath)]
    public static extern int H264_DVR_GetDDNSInfo(
        ref SearchMode searchmode,
        out DDNS_INFO[] pDevicInfo,
        int maxDeviceNum,
        out int nretNum
    );
    ...
    // 播放本地文件
    [DllImport(DllPath)]
    public static extern SDK_HANDLE H264_DVR_StartLocalPlay(
        string pFileName,
        IntPtr hWnd,
        fPlayDrawCallBack drawCallBack,
        uint user
    );
    ...
    //播放控制（播放，停止，恢复，快发，慢放）
    [DllImport(DllPath)]
    public static extern bool H264_DVR_LocalPlayCtrl(
        SDK_HANDLE lPlayHandle,
    ...
    //设置播放结束回调
    [DllImport(DllPath)]
    public static extern bool H264_DVR_SetFileEndCallBack(
        SDK_HANDLE lPlayHandle,
    ...
    //设置信息帧回调
    [DllImport(DllPath)]
    public static extern bool H264_DVR_SetInfoFrameCallBack(
        SDK_HANDLE lPlayHandle,
    ...
    //设置数据回调
    [DllImport(DllPath)]
    public static extern bool H264_DVR_SetRealDataCallBack_V2(
        SDK_HANDLE lRealHandle,
        fRealDataCallBack_V2 cbRealData,
        IntPtr dwUser
    );

    //删除数据回调
    [DllImport(DllPath)]
    public static extern bool H264_DVR_DelRealDataCallBack_V2(
        SDK_HANDLE lRealHandle,
        fRealDataCallBack_V2 cbRealData,
        IntPtr dwUser
    );
    ...
    //设置心跳保活
    [DllImport(DllPath)]
    public static extern bool H264_DVR_SetKeepLifeTime(int lLoginID, uint perKeeplifeTime, uint detectDisconTime);

    //设置系统时间
    [DllImport(DllPath)]
    public static extern bool H264_DVR_SetSystemDateTime(
        long lLoginID,
        ref SDK_SYSTEM_TIME pSysTime,
        [MarshalAs(UnmanagedType.Bool)] bool nType = true
    );
    ...
    //waittime		查询超时时间
    [DllImport(DllPath)]
    public static extern int H264_DVR_FindFile(
        SDK_HANDLE lLoginID,
        ref H264_DVR_FINDINFO lpFindInfo,
        IntPtr ptr,
        int lMaxCount,
        out int findcount,
        int waittime
    ...
    [DllImport(DllPath)]
    public static extern int H264_DVR_GetFileByName(
        SDK_HANDLE lLoginID,
        ref H264_DVR_FILE_DATA sPlayBackFile,
    ...
    [DllImport(DllPath)]
    public static extern int H264_DVR_GetFileByTime(
        SDK_HANDLE lLoginID,
        ref H264_DVR_FINDINFO lpFindInfo,
    ...
    [DllImport(DllPath)]
    public static extern int H264_DVR_PlayBackByName_V2(
        SDK_HANDLE lLoginID,
        ref H264_DVR_FILE_DATA sPlayBackFile,
        fDownLoadPosCallBack cbDownLoadPos,
        fRealDataCallBack_V2 fDownLoadDataCallBack,
        int dwDataUser
    );

    [DllImport(DllPath)]
    public static extern int H264_DVR_PlayBackByTimeEx(
        SDK_HANDLE lLoginID,
        ref H264_DVR_FINDINFO lpFindInfo,
        fRealDataCallBack fDownLoadDataCallBack,
        int dwDataUser,
    ...
    [DllImport(DllPath)]
    public static extern bool H264_DVR_PTZControl(
        SDK_HANDLE lLoginID,
        int nChannelNo,
        int lPTZCommand,
        bool bStop,
...
#pragma warning restore CA1051,CA1810,CA1815,CA2201,CA2211,CA2020,CS8600,CS8603,CS8605,CS8625,CA1838
